...
import { Bot, Play, Square, ArrowUpRight, Plus, AlertTriangle, DollarSign, TrendingUp, Clock } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="live-indicator">{botsData.activeBots} Active</span>
        </div>
