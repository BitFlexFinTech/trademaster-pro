  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        if (error) throw error;
        toast({ title: 'Account created!', description: 'Welcome to ArbTerminal.' });
        navigate('/dashboard');
      }
    } catch (error: any) {
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-card border-r border-border p-12 flex-col justify-between">
        <div>
          <div className="flex items-center gap-2 mb-8">
            ...
            <span className="text-2xl font-bold text-foreground">ArbTerminal</span>
          </div>
          <h1 className="text-4xl font-bold text-foreground mb-4">
            Professional Crypto<br />Arbitrage Platform
          </h1>
          <p className="text-muted-foreground text-lg">
            Real-time arbitrage opportunities, AI-powered signals, and comprehensive portfolio management.
          </p>
        </div>
        ...
        <div className="space-y-6">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Live cryptocurrency prices from CoinGecko with WebSocket updates.</p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 rounded-lg bg-primary/20 flex items-center justify-center flex-shrink-0">
            ...
            <div>
              <h3 className="font-semibold text-foreground">50+ Opportunities</h3>
              <p className="text-sm text-muted-foreground">Constantly updated arbitrage opportunities across major exchanges.</p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 rounded-lg bg-primary/20 flex items-center justify-center flex-shrink-0">
            ...
            <div>
              <h3 className="font-semibold text-foreground">Secure & Encrypted</h3>
              <p className="text-sm text-muted-foreground">AES-256 encryption for all API keys and sensitive data.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="card-terminal p-8">
            ...
            <p className="text-muted-foreground mb-6">
              {isLogin ? 'Enter your credentials to access your account' : 'Start trading with AI-powered insights'}
            </p>
